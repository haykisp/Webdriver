...
class Browser:
    ...
    def create_new_driver(driver_id):
        ...
        def get_driver():
            ...
            elif Browser.PHANTOM == driver_id:
    ...
    @staticmethod
    def open_new_tab():
        Browser.get_driver().find_element_by_tag_name("body").sendKeys(Keys.CONTROL + 't')
...
if "__main__" == __name__:
    ...
    urls = ["https://www.vbet.com",
            "https://www.vivarobet.am",
            "http://www.regularbet.com"]
    ...
    for url in urls:
        ...
        thread.name = "[URL: {}]".format(urls.index(url))
        thread.start()
